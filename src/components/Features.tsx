    ...
    description: (
      <>
        ...
        <span className="text-white font-semibold">
          LeetCode Premium datasets.
        </span>{" "}
        Enter any company name and the AI will pull real questions asked in
        their interviews.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <span className="text-white font-semibold">
          Dynamic Programming, Graphs, or Low-Level Design.
        </span>
      </>
    ),
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {features.map((feature) => (
            ...
            >
              <div
                className={`pointer-events-none absolute -right-14 -top-14 h-40 w-40 rounded-full blur-3xl ${feature.accentGlow}`}
                aria-hidden="true"
              ></div>

              <div
                className={`relative z-10 w-12 h-12 rounded-xl flex items-center justify-center mb-6 ring-1 ring-white/10 ${feature.iconBg}`}
              >
                <svg
              ...
              <h3 className="relative z-10 text-2xl font-semibold tracking-tight mb-3">
                {feature.title}
              </h3>

              <p className="relative z-10 text-slate-300/90 text-base leading-8">
                {feature.description}
              </p>
            </article>
          ))}
